...
障害物[ Obstacle.cpp ]
(Maybe-Later:char*だとデータの受け渡しに失敗しているためstd::stringにしている)
-------------------------------------------------------------------------------
■  Author
Ohno Takuya
...
{
	auto object = new ObstaclePillar;
...
void ObstaclePillar::Initialize(void)
{
...
void ObstaclePillar::Uninitialize(void)
{
...
void ObstaclePillar::WorldTransform(LPDIRECT3DDEVICE9 Device)
{
	D3DXVECTOR3 Position = Object::GetPosition();
...
void ObstaclePillar::ConfigShader(LPDIRECT3DDEVICE9 device)
{
	...
	D3DXVECTOR3 lightDirW = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	pixelShaderConstantTable->SetValue(device, "lightDirW", lightDirW, sizeof(lightDirW));

	D3DXVECTOR3 Pos[9] = {D3DXVECTOR3(-90.0f, 70.0f,   95.0f), D3DXVECTOR3(21.0f, 70.0f,   95.0f), D3DXVECTOR3(125.0f, 70.0f,   95.0f),
						  D3DXVECTOR3(-90.0f, 70.0f,  -15.0f), D3DXVECTOR3(21.0f, 70.0f,  -15.0f), D3DXVECTOR3(125.0f, 70.0f,  -15.0f),
						  D3DXVECTOR3(-90.0f, 70.0f, -115.0f), D3DXVECTOR3(21.0f, 70.0f, -115.0f), D3DXVECTOR3(125.0f, 70.0f, -115.0f)};
